...
### Objective
Now that we have a component to display individual comments, let's build a connected list component to display all the comments for the current video.
...
### Objective
Congratulations! You've now implemented all the building blocks you need for your client's Youtube player, and since you let tests drive their implementations you're confident that each works on its own.
In this step we'll put all our building blocks together into a layout component and then write some integration tests to make sure they all work together. We'll introduce a powerful feature of Jest - module mocking - 
and also learn how to mock API requests using Jest.

### Resources
- [Jest Mock Functions](https://jestjs.io/docs/en/mock-functions)
- [Jest Mock Modules](https://jestjs.io/docs/en/mock-functions#mocking-modules)

## TODO:
- Implement a layout component using TDCD and Jest mock modules
- Write an integration test suite using Jest mock functions to mock API requests

## Step 19

### Recap: What did we learn?
- Introduction to mocking modules with Jest
- Introduction to mocking API requests with Jest
...
### Recap: What did we learn?
- We can signifcantly refactor the presentational concerns of our application while are tests are green!
- Focusing solely on presentation concerns lets us tackle that difficult free of concerns about behavior and logic 

### TODO:
NOTHING! Go play some of your favorite videos on your client's new Youtube player
